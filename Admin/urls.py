...
urlpatterns = [
    ...
    path('admin_dashboard_student_seven_two/<int:pk>/', views.Delete_Student_Seven_Two.as_view(), name='delete_student_seven_two'),
    path('admin_dashboard_student_eight_one/<int:pk>/', views.Delete_Student_Eight_One.as_view(), name='delete_student_eight_one'),
    path('admin_dashboard_student_eight_two/<int:pk>/', views.Delete_Student_Eight_Two.as_view(), name='delete_student_eight_two'),
    path('admin_dashboard_student_nine_one/<int:pk>/', views.Delete_Student_Nine_One.as_view(), name='delete_student_nine_one'),
    path('admin_dashboard_student_nine_two/<int:pk>/', views.Delete_Student_Nine_Two.as_view(), name='delete_student_nine_two'),
    ...
    path('admin_dashboard_teacher_seven_two/<int:pk>/', views.Delete_Teacher_Seven_Two.as_view(), name='delete_teacher_seven_two'),
    path('admin_dashboard_teacher_eight_one/<int:pk>/', views.Delete_Teacher_Eight_One.as_view(), name='delete_teacher_eight_one'),
    path('admin_dashboard_teacher_eight_two/<int:pk>/', views.Delete_Teacher_Eight_Two.as_view(), name='delete_teacher_eight_two'),
    path('admin_dashboard_teacher_nine_one/<int:pk>/', views.Delete_Teacher_Nine_One.as_view(), name='delete_teacher_nine_one'),
    path('admin_dashboard_teacher_nine_two/<int:pk>/', views.Delete_Teacher_Nine_Two.as_view(), name='delete_teacher_nine_two'),
